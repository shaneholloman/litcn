...
import "litcn/dist/PreviewCode.js";
import "litcn/dist/LanguageSelector.js";
import {
   defaultEnglish,
   defaultGerman,
   getCurrentLanguage,
...
\${Button({ children: \`\${i18n("Sort by")}: \${i18n("Date")}\` })}`}
  ...
  interface i18nMessages extends LiteCNRequiredMessages {
    ...
    "greeting": (name: string, time: string) => string;
                  ...
                  <code-block
                     .code=${`import { setTranslations, defaultEnglish, defaultGerman } from "litcn";
...
setTranslations(translations);`}
                  ...
                  <code-block
                     .code=${`import { i18n, getCurrentLanguage, setLanguage } from "litcn";
