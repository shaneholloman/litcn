...
import { Card, CardContent } from "litcn/dist/Card.js";
import type { ComponentDefinition, ExtractProps, VariantDef } from "litcn/dist/component.js";
...
export abstract class ComponentPage<T extends ComponentDefinition> extends LitElement {
   ...
   updatePlayground() {
      ...
      const functionalCode = `import { ${this.componentName} } from "litcn";
...
${this.componentName}({${Object.entries(settings)
      ...
      const webComponentCode = `import "litcn/dist/${this.componentName}.cva.js";
