...
import { Separator } from "litcn/dist/Separator.js";
import { Textarea } from "litcn/dist/Textarea.js";
import { Code, FileText, Key, Mail, Share, Terminal } from "lucide";

// Register the copy-button custom element
import "litcn/dist/CopyButton.js";
...
export class CopyButtonPage extends LitElement {
   ...
   @state() codeSnippet = `npm install litcn`;
   @state() longText =
         ...
         <div class="p-8 max-w-6xl mx-auto">
            ...
            <section class="mb-8">
               ...
               <preview-code
                  .preview=${html`
                     <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-4 p-3 bg-muted/50 rounded-md font-mono text-sm">
                           <code class="flex-1">npm install litcn</code>
                           <copy-button text="npm install litcn"></copy-button>
                        </div>
                  ...
                  `}
                  code=${`import "litcn/dist/CopyButton.js";
                     ...
                     <div class="space-y-6">
                        ...
                        <div>
                           ...
                           <div class="relative">
                              ...
                              ><code>${`import { CopyButton } from 'litcn';
...
></copy-button>`}</code></pre>
                              <div class="absolute top-2 right-2">
                                 <copy-button
                                    text="import { CopyButton } from 'litcn';
