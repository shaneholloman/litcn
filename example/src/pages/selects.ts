...
import { Select, type SelectGroup, type SelectOption } from "litcn/dist/Select.js";
  ...
  onChange: (value) => this.value = value
            ...
            <section class="my-8">
               ...
               <preview-code
                  ...
                  `}
                  code=${`import { Select, icon } from "litcn";
  ...
  onChange: (value) => this.countryValue = value
            ...
            <section class="my-8">
               ...
               <preview-code
                  ...
                  `}
                  code=${`import { Select, type SelectGroup } from "litcn";
