...
declare global {
   const __LITCN_VERSION__: string;
}
         ...
         <div class="p-8 max-w-4xl mx-auto">
            <div class="mb-8 text-center">
               ...
               <div class="flex gap-2 justify-center">
                  ${Badge({ variant: "default", children: `v${__LITCN_VERSION__}` })}
            ...
            <section class="mb-12">
               ...
               <div class="space-y-6">
                  <div>
                     ...
                     <code-block .code=${"npm install lit litcn"} language="bash"></code-block>
                  </div>
...
import { Button, Card, Badge, icon } from 'litcn'
...
`}
            ...
            <section class="mb-12">
               ...
               <div class="flex flex-wrap gap-4">
                  ${Button({
                     ...
                     `,
                     onClick: () => window.open("https://www.npmjs.com/package/litcn", "_blank"),
                  })}
                  ${Button({
                     variant: "outline",
                     children: html`
            ...
            <div class="text-center">
               ...
               <p class="text-muted-foreground text-sm">
                  ...
                  <a class="text-primary hover:underline" href="https://shaneholloman.at" target="_blank"
                     >shaneholloman</a
                  >
               </p>
            </div>
