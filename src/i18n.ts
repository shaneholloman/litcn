/**
 * Flexible i18n system for litcn
 *
 * Users can extend this with their own messages while ensuring
 * litcn's required messages are included.
 */

export type LanguageCode = "en" | "de" | string;

// Required messages for litcn components
export interface LiteCNRequiredMessages {
   "*": string;
   Copy: string;
   "Copy code": string;
   "Copied!": string;
...
export interface i18nMessages extends LiteCNRequiredMessages {
   // User's app messages go here via declaration merging
}

// Default minimal translations for litcn components
export const defaultEnglish: LiteCNRequiredMessages = {
   "*": "*",
   Copy: "Copy",
   "Copy code": "Copy code",
   "Copied!": "Copied!",
...
export const defaultGerman: LiteCNRequiredMessages = {
   "*": "*",
   Copy: "Kopieren",
 ...
 *
 * @example
 * import { setTranslations } from 'litcn';
 *
 * // Your messages must include all LiteCNRequiredMessages
 * const myTranslations = {
 *   en: {
 *     // Required litcn messages
 *     "Copy": "Copy",
 *     "Copied!": "Copied!",
